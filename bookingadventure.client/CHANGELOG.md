...
- Create Angular project with ng: `ng new bookingadventure.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bookingadventure.client.esproj`).
