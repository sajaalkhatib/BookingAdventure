...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-HJ7MGKN;Database=Adventure;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Adventure>(entity =>
        {
            entity.HasKey(e => e.AdventureId).HasName("PK__Adventur__D721A00EF328A61C");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Adventur__19093A0B9B687838");
        ...
        {
            entity.HasKey(e => e.ImageId).HasName("PK__Adventur__7516F70CD2664618");
        ...
        {
            entity.HasKey(e => e.TypeId).HasName("PK__Adventur__516F03B58D70B8EF");
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__Bookings__73951AEDFC2D384D");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__ContactM__C87C0C9C2C4C74E2");
        ...
        {
            entity.HasKey(e => e.DestinationId).HasName("PK__Destinat__DB5FE4CC217FD7C7");
            ...
            entity.HasMany(d => d.Categories).WithMany(p => p.Destinations)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("DestinationId", "CategoryId").HasName("PK__Destinat__7ACF776CD6959DD7");
        ...
        {
            entity.HasKey(e => e.InstructorId).HasName("PK__Instruct__9D010A9B48B3209A");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__74BC79CE479F14E7");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C15EC4E49");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534DCE0DED0").IsUnique();
